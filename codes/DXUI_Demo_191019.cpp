...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	github.Init({ 650, 530 }, { 400, 38 },
		...
		5.0f, 5.0f, 1.0f, L"微软雅黑", 20, false, false, true, DFontWeight::NormalWeight, DAlignment::Center, DAlignment::Center,
		{ 255, 255, 255, 1.0f }, 2.0f, { 255, 255, 255, 0.2f });
	...
	my.Init({ 10, 0 }, { AboutWidth - 40, AboutHeight - 100 },
		...
		L"微软雅黑", 20, true, DFontWeight::NormalWeight, DAlignment::Center, DAlignment::Center);
	...
	tb.Init({ 50, 410 }, { 500, 250 },
		...
		{ {240, 240, 240, 1.0f }, {220, 220, 220, 1.0f}, {0, 0, 0, 1.0f}, 0.3f },
		10.0f, 10.0f, 1.0f, L"微软雅黑", 20, true, true, false, DFontWeight::NormalWeight, DAlignment::Near, DAlignment::Near, { 255, 255, 255, 1.0f }, 2.0f);
