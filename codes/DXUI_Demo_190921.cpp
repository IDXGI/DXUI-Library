...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	github.Init({ 650, 530 }, { 400, 38 },
		...
		5.0f, 5.0f, 1.0f, L"微软雅黑", 20, false, false, true, NormalWeight, Center, Center, { 255, 255, 255, 0.2f });
	...
	ib.LoadFromResource({ 0, 0 }, { WindowWidth, WindowHeight }, IDR_PIC1, L"pic", nullptr, true, Fill, 1.0f, { 0, 0, 0, 0.0f }, { 0, 0, 0, 0.0f }, 0, 0);
	...
	Sleep(30);//因为创建渲染线程后，要先渲染第一帧再更新窗口，而此时直接显示窗口，会导致白屏一下再显示。
