...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	ShowUpdateRect.Init({ WindowWidth - 15, WindowHeight - 120 }, { 125, 50 },
		{ { 255, 255, 255, 0.15f }, { 60, 60, 60, 0.3f }, { 255, 255, 255, 0.0f }, 200 },
		{ { 255, 255, 255, 0.35f }, { 60, 60, 60, 0.5f }, { 255, 255, 255, 1.0f }, 200 },
		{ { 255, 255, 255, 0.65f }, { 30, 30, 30, 1.0f }, { 255, 255, 255, 1.0f }, 100 },
		{ { 0, 0, 0, 1.0f }, { 0, 0, 0, 1.0f }, { 0, 0, 0, 1.0f }, 300 },
		0.0f, 0.0f, 0.0f, L"显示更新区域", L"微软雅黑", 18);
	...
	good1.Init({ 570, 410 }, { 590, 100 },
		{ { 255, 255, 255, 0.85f }, false, false, 250 },
		{ { 66, 158, 30, 1.0f }, false, false, 250 },
		{ { 66, 158, 30, 1.0f }, false, false, 100 },
		false, L"目前有4种控件：按钮、标签、全自绘编辑框、图片框\n以后有时间准备增加控件页、列表等复杂控件", L"微软雅黑", 25, true, DFontWeight::Normal, DAlignment::Center, DAlignment::Center);

	picfrom.Init({ WindowWidth - 495, WindowHeight - 27 }, { 220, 20 },
		{ { 255, 255, 255, 0.6f }, false, false, 250 },
		{ { 255, 255, 255, 1.0f }, false, true, 250 },
		{ { 255, 255, 255, 1.0f }, false, true, 100 },
		false, L"感谢图片来源：QQ1924286463", L"微软雅黑", 15, true, DFontWeight::Normal, DAlignment::Center, DAlignment::Center);
	...
	gitlb.Init({ 570, 530 }, { 70, 40 },
		...
		{ { 255, 255, 255, 1.0f }, false, false, 250 },
		{ { 255, 255, 255, 1.0f }, false, false, 100 },
		false, L"Github:", L"微软雅黑", 20, true, DFontWeight::Normal, DAlignment::Center, DAlignment::Center);

	github.Init({ 650, 530 }, { 400, 38 },
		{ {240, 240, 240, 0.2f }, { 150, 150, 150, 1.0f }, {255, 255, 255, 1.0f}, 250 },
		{ {240, 240, 240, 0.2f }, {255, 255, 255, 1.0f}, {21, 182, 255, 1.0f}, 250 },
		{ {255, 255, 255, 0.1f }, {255, 255, 255, 1.0f}, {21, 182, 255, 1.0f}, 100 },
		{ {240, 240, 240, 1.0f }, {255, 255, 255, 1.0f}, {0, 0, 0, 1.0f}, 300 },
		5.0f, 5.0f, 1.5f, L"微软雅黑", 20, false, false, true, DFontWeight::Normal, DAlignment::Center, DAlignment::Center,
	...
	co.Init({ 5, 5 }, { 20, 20 }, { 0, 255, 0, 1.0f }, 10.0f, 10.0f);
	...
	co1.Init({ 130, 5 }, { 300, 50 }, { 0, 0, 0, 0.0f }, p, 2, { 130, 5 }, { 430, 55 }, 3.0f, 3.0f);
	co2.Init({ 760, 5 }, { 300, 90 }, { 0, 0, 0, 0.0f }, p, 2, { 910, 50 }, 150.0f, 150.0f, 12.0f, 12.0f);
	//主窗口初始化
	...
	if (hWnd == Main)//多窗口时的分辨处理
	{
		...
		case DControlMsg::Control_StateChanged:
		{
			...
			else if (id == ShowUpdateRect)
			{
				if (after == DControlState::MouseMove || after == DControlState::Click)
				{
					ShowUpdateRect.SetPosition(WindowWidth - 125, WindowHeight - 120, 600, &b);
				}
				else if (after == DControlState::Normal)
				{
					ShowUpdateRect.SetPosition(WindowWidth - 15, WindowHeight - 120, 600, &b);
				}
			}
			else if (id == co)
			{
				...
				{
					co.SetTotalOpacity(0.5f, 100);
				}
				else if (after == DControlState::Normal)
				{
					co.SetTotalOpacity(1.0f, 100);
				}
			}
			else if (id == co1)
			{
